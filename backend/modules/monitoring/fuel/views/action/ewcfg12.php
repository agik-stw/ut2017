...
define("EW_PROJECT_NAME", "newphpmaker12project", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{6C2D28B4-9AD2-4C08-A6B0-679C21196D80}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '4UIcKddxygy7b5en', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/theme-default.css", TRUE); // "phpcss/newphpmaker12project.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" =>"3306", "user" => "root", "pass" => "", "db" => "others_npmp12", "qs" => "`", "qe" => "`");
...
define("EW_SESSION_TIMEOUT", 10, TRUE); // Session timeout time (minutes)

// Session keep alive interval
define("EW_SESSION_KEEP_ALIVE_INTERVAL", 300, TRUE); // Session keep alive interval (seconds)
...
$EW_LANGUAGE_FILE[] = array("ar", "", "arabic_newproject.xml");
$EW_LANGUAGE_FILE[] = array("en", "", "english_newproject.xml");
$EW_LANGUAGE_FILE[] = array("id", "", "indonesian_newproject.xml");
...
define("MS_SHOW_DETAILCOUNT_GREATER_THAN_ZERO_ONLY", FALSE, TRUE);
define("MS_USE_BADGE_FOR_DETAILCOUNT", FALSE, TRUE);
...
define("MS_AUTO_LOGOUT_AFTER_IDLE_IN_MINUTES", 10, TRUE); // get from project setting since v12 = 10 minutes!
...
define("MS_TABLE_SELECTABLE_REC_PER_PAGE_LIST", "10,20,50,100,500", TRUE); // Selectable records per page list, derived from PHPMaker -> PHP -> List/View Page Options (Global) -> Selectable page sizes
define("MS_TABLE_MAXIMUM_SELECTED_RECORDS", 20, TRUE); // Maximum selected records per page
define("MS_TABLE_RECPERPAGE_VALUE", 50, TRUE); // Default records per page value
...
// Begin of modification Help table, by Masino Sinaga, June 6, 2012

/*define("MS_HELP_TABLE", "help", TRUE);*/ // Help table name; just in case. Adjust with yours!
/*define("MS_HELP_CATEGORIES_TABLE", "help_categories", TRUE);*/ // Help Categories table name; just in case. Adjust with yours!

// End of modification Help table, by Masino Sinaga, June 6, 2012
// Begin of modification Languages table, by Masino Sinaga, June 6, 2012
