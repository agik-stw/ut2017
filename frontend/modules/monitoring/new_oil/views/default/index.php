   ...
   /* { "width": "100px", "targets": 9 },
    ...
    { "width": "60px", "targets": 12 },*/
     ...
     "bSort": false,
        ...
        "autoWidth": true,
        "ajax": {
          "url": "<?php echo Url::toRoute('/monitoring/new_oil/action/getdata');?>",
          'type':'get'
        },
    columns: [
    {
...
tb.ajax.url( "<?php echo Url::toRoute('/monitoring/new_oil/action/getdata');?>").load();
   }else if($("#select-date").val()=='receive_date'){
tb.ajax.url( "<?php echo Url::toRoute('/monitoring/new_oil/action/get_by_receive_date?');?>"+'date1='+dateStart+'&date2='+dateEnd ).load();
   }else if($("#select-date").val()=='analysis_date'){
tb.ajax.url( "<?php echo Url::toRoute('/monitoring/new_oil/action/get_by_report_date?');?>"+'date1='+dateStart+'&date2='+dateEnd ).load();
   }else if($("#select-date").val()=='sample_date'){
tb.ajax.url( "<?php echo Url::toRoute('/monitoring/new_oil/action/get_by_sample_date?');?>"+'date1='+dateStart+'&date2='+dateEnd ).load();
   }
});
