...
define("EW_PROJECT_NAME", "kpc_report", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{1F4B2E75-EDFB-41A5-A2C6-112C22BE2572}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'mr6dnMR93GsvvxJK', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/theme-default.css", TRUE); // "phpcss/kpc_report.css", TRUE); // Project stylesheet file name
...
$EW_LANGUAGE_FILE[] = array("en", "", "english_kpc_report.xml");
$EW_LANGUAGE_FILE[] = array("id", "", "indonesian_kpc_report.xml");
...
define("EW_USER_ID_FILTER", "(`CustomerID` = %u)",  TRUE);
...
// Email
define("EW_SMTP_SERVER", "mail.petrolab.co.id", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "adm.sangatta@petrolab.co.id", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "adm.sangatta@petrolab.co.id", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "adm.sangatta@petrolab.co.id", TRUE); // Recipient email address
...
?>
<?php
define("MS_USE_PHPMAKER_SETTING_FOR_INITIATE_SEARCH_PANEL", FALSE, TRUE); 
...
define("MS_PAGINATION_POSITION", 1, TRUE); // 1 = Top, 2 = Bottom, 3 = Top and Bottom
define("MS_SELECTABLE_PAGE_SIZES_POSITION", "Left", TRUE); // "Left" or "Right"
define("MS_TABLE_SELECTABLE_REC_PER_PAGE_LIST", "5,10,20,50,100,500", TRUE); // Selectable records per page list, derived from PHPMaker -> PHP -> List/View Page Options (Global) -> Selectable page sizes
...
define("MS_TABLE_WIDTH_STYLE", "2", TRUE);  // 1 = Scroll, 2 = Normal, 3 = 100%
define("MS_SCROLL_TABLE_HEIGHT", 350, TRUE); // The height size of the scrolling table
define("MS_SCROLL_TABLE_WIDTH", 1200, TRUE);  // The width size of the scrolling table
...
define("MS_DETECT_CHANGES_ON_CHANGEPASSWORD_FORM", FALSE, TRUE);
?>
<?php
...
define("MS_SHOW_CAPTCHA_ON_CHANGE_PASSWORD_PAGE", FALSE, TRUE); // <-- Switch FALSE (second param) to TRUE if you want to display Captcha on the Change Password page
?>
