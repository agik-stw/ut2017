...
define("EW_PROJECT_NAME", "kpc_report_new", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{77606850-1680-4FE0-9A99-CEB210DEB9EB}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'sy4x968gY3jQ6tnk', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/kpc_report_new.css", TRUE); // Project stylesheet file name
...
define("EW_ADMIN_PASSWORD", "petrolabpapsgt", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`tbl_users`",  TRUE);
...
define("EW_MENUBAR_BRAND", "UT PAP", TRUE);
define("EW_MENUBAR_BRAND_HYPERLINK", "index.php", TRUE);
