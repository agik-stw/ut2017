...
/**
 * Class ExcelLib is extend of Excel Library
 * @package common\modules\transaction\models
 */
class ExcelLib extends Excel
{
...
class Excel{
     ...
     * @param $filename string the xls file name
     */
    ...
    /**
     * write a number
     * @param $Row int row to write $Value (first row is 0)
     * @param $Col int column to write $Value (first column is 0)
